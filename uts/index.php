...
<section class="category">
   ...
   <div class="box-container">
      <a href="category.php?category=ramen" class="box">
         <img src="images/ramen.jpg" alt="">
         <h3>Ramen</h3>
      </a>
      <a href="category.php?category=sushi" class="box">
         <img src="images/sushi.jpg" alt="">
         <h3>Sushi</h3>
      </a>
      <a href="category.php?category=drinks" class="box">
         <img src="images/ocha.jpg" alt="">
         <h3>Drinks</h3>
      </a>
      <a href="category.php?category=desserts" class="box">
         <img src="images/dango.jpg" alt="">
         <h3>Desserts</h3>
      </a>
   </div>
</section>
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="flex">
            ...
            <input type="number" name="qty" class="qty" min="1" max="99" placeholder="Maks. 99" value="1" maxlength="2">
         </div>
      </form>
      <?php
            }
